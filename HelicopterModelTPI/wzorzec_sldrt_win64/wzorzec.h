...
#ifndef RTW_HEADER_wzorzec_h_
#define RTW_HEADER_wzorzec_h_
#include <string.h>
#include <stddef.h>
#ifndef wzorzec_COMMON_INCLUDES_
#define wzorzec_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* wzorzec_COMMON_INCLUDES_ */

#include "wzorzec_types.h"
...
#define wzorzec_rtModel                RT_MODEL_wzorzec_T

/* Block signals (default storage) */
typedef struct {
  real_T AzimuthCtrl1;                 /* '<Root>/AzimuthCtrl1' */
  ...
  real_T Saturation_o[2];              /* '<S2>/Saturation' */
  real_T PWM[2];                       /* '<S2>/PWM' */
...
typedef struct {
  struct {
    void *LoggedData[3];
  } AngleControl1_PWORK;               /* '<Root>/Angle & Control1' */
...
#define rtB                            wzorzec_B
#define BlockIO                        B_wzorzec_T
#define rtX                            wzorzec_X
#define ContinuousStates               X_wzorzec_T
#define rtXdot                         wzorzec_XDot
#define StateDerivatives               XDot_wzorzec_T
#define tXdis                          wzorzec_XDis
#define StateDisabled                  XDis_wzorzec_T
#define rtP                            wzorzec_P
#define Parameters                     P_wzorzec_T
#define rtDWork                        wzorzec_DW
#define D_Work                         DW_wzorzec_T
#define ConstParam                     ConstP_wzorzec_T
#define rtcP                           wzorzec_ConstP
...
struct P_wzorzec_T_ {
  ...
  real_T Normal1_Value;                /* Expression: 0
                                        ...
                                        */
  real_T AzimuthCtrl1_Value;           /* Expression: 0
...
extern P_wzorzec_T wzorzec_P;

/* Block signals (default storage) */
extern B_wzorzec_T wzorzec_B;

/* Continuous states (default storage) */
extern X_wzorzec_T wzorzec_X;

/* Block states (default storage) */
extern DW_wzorzec_T wzorzec_DW;

/* Constant parameters (default storage) */
extern const ConstP_wzorzec_T wzorzec_ConstP;

/* Model entry point functions */
extern void wzorzec_initialize(void);
extern void wzorzec_output(void);
extern void wzorzec_update(void);
extern void wzorzec_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern wzorzec_rtModel *wzorzec(void);
...
extern RT_MODEL_wzorzec_T *const wzorzec_M;
 ...
 *
 * '<Root>' : 'wzorzec'
 * '<S1>'   : 'wzorzec/Subsystem'
 * '<S2>'   : 'wzorzec/TRAS1'
 */
#endif                                 /* RTW_HEADER_wzorzec_h_ */
