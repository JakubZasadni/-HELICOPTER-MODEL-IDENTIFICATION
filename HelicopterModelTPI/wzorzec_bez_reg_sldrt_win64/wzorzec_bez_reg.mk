...
MODEL                := wzorzec_bez_reg
MODULES              := rt_matrx.c rt_printf.c rtGetInf.c rtGetNaN.c rt_nonfinite.c wzorzec_bez_reg_data.c wzorzec_bez_reg_tgtconn.c TRAS_AnalogInput.c TRAS_BitstreamVersion.c TRAS_Encoder.c TRAS_PWM.c TRAS_PWMPrescaler.c TRAS_PWMTherm.c TRAS_ResetEncoder.c TRAS_ThermFlag.c
MAKEFILE             := wzorzec_bez_reg.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := wzorzec_bez_reg_ref.rsp
...
# additional includes
REQ_INCLUDES += ;D:/MATLAB_WORK/ident_2024_czw_11_30;D:/MATLAB_WORK/ident_2024_czw_11_30/wzorzec_bez_reg_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
