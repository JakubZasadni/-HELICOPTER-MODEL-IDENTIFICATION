...
#ifndef RTW_HEADER_wzorzec_bez_reg_h_
#define RTW_HEADER_wzorzec_bez_reg_h_
#include <string.h>
#include <stddef.h>
#include <math.h>
#ifndef wzorzec_bez_reg_COMMON_INCLUDES_
#define wzorzec_bez_reg_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* wzorzec_bez_reg_COMMON_INCLUDES_ */

#include "wzorzec_bez_reg_types.h"
...
#define wzorzec_bez_reg_rtModel        RT_MODEL_wzorzec_bez_reg_T
...
typedef struct {
  real_T TransferFcn_CSTATE;           /* '<Root>/Transfer Fcn' */
} XDot_wzorzec_bez_reg_T;

/* State disabled  */
typedef struct {
  boolean_T TransferFcn_CSTATE;        /* '<Root>/Transfer Fcn' */
} XDis_wzorzec_bez_reg_T;
...
#define rtB                            wzorzec_bez_reg_B
#define BlockIO                        B_wzorzec_bez_reg_T
#define rtX                            wzorzec_bez_reg_X
#define ContinuousStates               X_wzorzec_bez_reg_T
#define rtXdot                         wzorzec_bez_reg_XDot
#define StateDerivatives               XDot_wzorzec_bez_reg_T
#define tXdis                          wzorzec_bez_reg_XDis
#define StateDisabled                  XDis_wzorzec_bez_reg_T
#define rtP                            wzorzec_bez_reg_P
#define Parameters                     P_wzorzec_bez_reg_T
#define rtDWork                        wzorzec_bez_reg_DW
#define D_Work                         DW_wzorzec_bez_reg_T

/* Parameters (default storage) */
struct P_wzorzec_bez_reg_T_ {
...
struct tag_RTM_wzorzec_bez_reg_T {
  const char_T *path;
...
extern P_wzorzec_bez_reg_T wzorzec_bez_reg_P;

/* Block signals (default storage) */
extern B_wzorzec_bez_reg_T wzorzec_bez_reg_B;

/* Continuous states (default storage) */
extern X_wzorzec_bez_reg_T wzorzec_bez_reg_X;

/* Block states (default storage) */
extern DW_wzorzec_bez_reg_T wzorzec_bez_reg_DW;

/* Model entry point functions */
extern void wzorzec_bez_reg_initialize(void);
extern void wzorzec_bez_reg_output(void);
extern void wzorzec_bez_reg_update(void);
extern void wzorzec_bez_reg_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern wzorzec_bez_reg_rtModel *wzorzec_bez_reg(void);
...
extern RT_MODEL_wzorzec_bez_reg_T *const wzorzec_bez_reg_M;
 ...
 *
 * '<Root>' : 'wzorzec_bez_reg'
 * '<S1>'   : 'wzorzec_bez_reg/TRAS'
 */
#endif                                 /* RTW_HEADER_wzorzec_bez_reg_h_ */
