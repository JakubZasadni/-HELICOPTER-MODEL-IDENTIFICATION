...
MODEL                := TRAS_PID_Azimuth
MODULES              := rt_matrx.c rt_printf.c TRAS_PID_Azimuth_data.c TRAS_PID_Azimuth_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c TRAS_AnalogInput.c TRAS_BitstreamVersion.c TRAS_Encoder.c TRAS_PWM.c TRAS_PWMPrescaler.c TRAS_PWMTherm.c TRAS_ResetEncoder.c TRAS_ThermFlag.c
MAKEFILE             := TRAS_PID_Azimuth.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := TRAS_PID_Azimuth_ref.rsp
...
# additional includes
REQ_INCLUDES += ;D:/MATLAB_WORK/LaboratoriumProblemowe/wzorzec;D:/MATLAB_WORK/LaboratoriumProblemowe/wzorzec/TRAS_PID_Azimuth_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
