...
#ifndef RTW_HEADER_TRAS_PID_Azimuth_h_
#define RTW_HEADER_TRAS_PID_Azimuth_h_
#include <string.h>
#include <stddef.h>
#include <math.h>
#ifndef TRAS_PID_Azimuth_COMMON_INCLUDES_
#define TRAS_PID_Azimuth_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* TRAS_PID_Azimuth_COMMON_INCLUDES_ */

#include "TRAS_PID_Azimuth_types.h"
...
#define TRAS_PID_Azimuth_rtModel       RT_MODEL_TRAS_PID_Azimuth_T

/* Block signals (default storage) */
typedef struct {
  real_T Encoder[2];                   /* '<S2>/Encoder' */
  real_T Converttorad[2];              /* '<S2>/Convert to rad' */
  real_T ReferenceAngleGenerator;      /* '<Root>/Reference Angle Generator' */
  real_T FilterCoefficient;            /* '<S37>/Filter Coefficient' */
  real_T Sum;                          /* '<S43>/Sum' */
  real_T FilteredControl;              /* '<Root>/Control FIlter' */
...
} B_TRAS_PID_Azimuth_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  real_T ControlFIlter_states[5];      /* '<Root>/Control FIlter' */
  real_T ControlFIlter_tmp;            /* '<Root>/Control FIlter' */
  struct {
    void *LoggedData[3];
  } AngleControl_PWORK;                /* '<Root>/Angle & Control' */

  struct {
    void *LoggedData;
  } RPM_PWORK;                         /* '<Root>/RPM' */
} DW_TRAS_PID_Azimuth_T;

/* Continuous states (default storage) */
typedef struct {
  real_T Integrator_CSTATE;            /* '<S34>/Integrator' */
  real_T Filter_CSTATE;                /* '<S29>/Filter' */
} X_TRAS_PID_Azimuth_T;

/* State derivatives (default storage) */
typedef struct {
  real_T Integrator_CSTATE;            /* '<S34>/Integrator' */
  real_T Filter_CSTATE;                /* '<S29>/Filter' */
} XDot_TRAS_PID_Azimuth_T;

/* State disabled  */
typedef struct {
  boolean_T Integrator_CSTATE;         /* '<S34>/Integrator' */
  boolean_T Filter_CSTATE;             /* '<S29>/Filter' */
} XDis_TRAS_PID_Azimuth_T;
...
#define rtB                            TRAS_PID_Azimuth_B
#define BlockIO                        B_TRAS_PID_Azimuth_T
#define rtX                            TRAS_PID_Azimuth_X
#define ContinuousStates               X_TRAS_PID_Azimuth_T
#define rtXdot                         TRAS_PID_Azimuth_XDot
#define StateDerivatives               XDot_TRAS_PID_Azimuth_T
#define tXdis                          TRAS_PID_Azimuth_XDis
#define StateDisabled                  XDis_TRAS_PID_Azimuth_T
#define rtP                            TRAS_PID_Azimuth_P
#define Parameters                     P_TRAS_PID_Azimuth_T
#define rtDWork                        TRAS_PID_Azimuth_DW
#define D_Work                         DW_TRAS_PID_Azimuth_T

/* Parameters (default storage) */
struct P_TRAS_PID_Azimuth_T_ {
  ...
  real_T Converttorad_Gain;            /* Expression: 2*pi/4096
                                        ...
                                        */
  real_T ReferenceAngleGenerator_Amplitude;/* Expression: 0.5
                                            * Referenced by: '<Root>/Reference Angle Generator'
                                            */
  real_T ReferenceAngleGenerator_Frequency;/* Expression: 0.05
                                            * Referenced by: '<Root>/Reference Angle Generator'
                                            */
  real_T ControlFIlter_NumCoef[6];
  /* Expression: [0.0598    0.2990    0.5980    0.5980    0.2990    0.0598] * 1e-3
   * Referenced by: '<Root>/Control FIlter'
   */
  real_T ControlFIlter_DenCoef[6];
       /* Expression: [1.0000   -3.9845    6.4349   -5.2536    2.1651   -0.3599]
        * Referenced by: '<Root>/Control FIlter'
        */
  real_T ControlFIlter_InitialStates;  /* Expression: 0
                                        * Referenced by: '<Root>/Control FIlter'
                                        */
  ...
  real_T ConverttoRPM_Gain;            /* Expression: 1000/0.52/2
                                        ...
                                        */
  real_T ZeroPitchControl_Value;       /* Expression: 0
...
struct tag_RTM_TRAS_PID_Azimuth_T {
  const char_T *path;
...
extern P_TRAS_PID_Azimuth_T TRAS_PID_Azimuth_P;

/* Block signals (default storage) */
extern B_TRAS_PID_Azimuth_T TRAS_PID_Azimuth_B;

/* Continuous states (default storage) */
extern X_TRAS_PID_Azimuth_T TRAS_PID_Azimuth_X;

/* Block states (default storage) */
extern DW_TRAS_PID_Azimuth_T TRAS_PID_Azimuth_DW;

/* Model entry point functions */
extern void TRAS_PID_Azimuth_initialize(void);
extern void TRAS_PID_Azimuth_output(void);
extern void TRAS_PID_Azimuth_update(void);
extern void TRAS_PID_Azimuth_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern TRAS_PID_Azimuth_rtModel *TRAS_PID_Azimuth(void);
...
extern RT_MODEL_TRAS_PID_Azimuth_T *const TRAS_PID_Azimuth_M;
 ...
 *
 * '<Root>' : 'TRAS_PID_Azimuth'
 * '<S1>'   : 'TRAS_PID_Azimuth/PID Controller'
 * '<S2>'   : 'TRAS_PID_Azimuth/TRAS'
 * '<S3>'   : 'TRAS_PID_Azimuth/PID Controller/Anti-windup'
 * '<S4>'   : 'TRAS_PID_Azimuth/PID Controller/D Gain'
 * '<S5>'   : 'TRAS_PID_Azimuth/PID Controller/Filter'
 * '<S6>'   : 'TRAS_PID_Azimuth/PID Controller/Filter ICs'
 * '<S7>'   : 'TRAS_PID_Azimuth/PID Controller/I Gain'
 * '<S8>'   : 'TRAS_PID_Azimuth/PID Controller/Ideal P Gain'
 * '<S9>'   : 'TRAS_PID_Azimuth/PID Controller/Ideal P Gain Fdbk'
 * '<S10>'  : 'TRAS_PID_Azimuth/PID Controller/Integrator'
 * '<S11>'  : 'TRAS_PID_Azimuth/PID Controller/Integrator ICs'
 * '<S12>'  : 'TRAS_PID_Azimuth/PID Controller/N Copy'
 * '<S13>'  : 'TRAS_PID_Azimuth/PID Controller/N Gain'
 * '<S14>'  : 'TRAS_PID_Azimuth/PID Controller/P Copy'
 * '<S15>'  : 'TRAS_PID_Azimuth/PID Controller/Parallel P Gain'
 * '<S16>'  : 'TRAS_PID_Azimuth/PID Controller/Reset Signal'
 * '<S17>'  : 'TRAS_PID_Azimuth/PID Controller/Saturation'
 * '<S18>'  : 'TRAS_PID_Azimuth/PID Controller/Saturation Fdbk'
 * '<S19>'  : 'TRAS_PID_Azimuth/PID Controller/Sum'
 * '<S20>'  : 'TRAS_PID_Azimuth/PID Controller/Sum Fdbk'
 * '<S21>'  : 'TRAS_PID_Azimuth/PID Controller/Tracking Mode'
 * '<S22>'  : 'TRAS_PID_Azimuth/PID Controller/Tracking Mode Sum'
 * '<S23>'  : 'TRAS_PID_Azimuth/PID Controller/Tsamp - Integral'
 * '<S24>'  : 'TRAS_PID_Azimuth/PID Controller/Tsamp - Ngain'
 * '<S25>'  : 'TRAS_PID_Azimuth/PID Controller/postSat Signal'
 * '<S26>'  : 'TRAS_PID_Azimuth/PID Controller/preSat Signal'
 * '<S27>'  : 'TRAS_PID_Azimuth/PID Controller/Anti-windup/Passthrough'
 * '<S28>'  : 'TRAS_PID_Azimuth/PID Controller/D Gain/Internal Parameters'
 * '<S29>'  : 'TRAS_PID_Azimuth/PID Controller/Filter/Cont. Filter'
 * '<S30>'  : 'TRAS_PID_Azimuth/PID Controller/Filter ICs/Internal IC - Filter'
 * '<S31>'  : 'TRAS_PID_Azimuth/PID Controller/I Gain/Internal Parameters'
 * '<S32>'  : 'TRAS_PID_Azimuth/PID Controller/Ideal P Gain/Passthrough'
 * '<S33>'  : 'TRAS_PID_Azimuth/PID Controller/Ideal P Gain Fdbk/Disabled'
 * '<S34>'  : 'TRAS_PID_Azimuth/PID Controller/Integrator/Continuous'
 * '<S35>'  : 'TRAS_PID_Azimuth/PID Controller/Integrator ICs/Internal IC'
 * '<S36>'  : 'TRAS_PID_Azimuth/PID Controller/N Copy/Disabled'
 * '<S37>'  : 'TRAS_PID_Azimuth/PID Controller/N Gain/Internal Parameters'
 * '<S38>'  : 'TRAS_PID_Azimuth/PID Controller/P Copy/Disabled'
 * '<S39>'  : 'TRAS_PID_Azimuth/PID Controller/Parallel P Gain/Internal Parameters'
 * '<S40>'  : 'TRAS_PID_Azimuth/PID Controller/Reset Signal/Disabled'
 * '<S41>'  : 'TRAS_PID_Azimuth/PID Controller/Saturation/Passthrough'
 * '<S42>'  : 'TRAS_PID_Azimuth/PID Controller/Saturation Fdbk/Disabled'
 * '<S43>'  : 'TRAS_PID_Azimuth/PID Controller/Sum/Sum_PID'
 * '<S44>'  : 'TRAS_PID_Azimuth/PID Controller/Sum Fdbk/Disabled'
 * '<S45>'  : 'TRAS_PID_Azimuth/PID Controller/Tracking Mode/Disabled'
 * '<S46>'  : 'TRAS_PID_Azimuth/PID Controller/Tracking Mode Sum/Passthrough'
 * '<S47>'  : 'TRAS_PID_Azimuth/PID Controller/Tsamp - Integral/Passthrough'
 * '<S48>'  : 'TRAS_PID_Azimuth/PID Controller/Tsamp - Ngain/Passthrough'
 * '<S49>'  : 'TRAS_PID_Azimuth/PID Controller/postSat Signal/Forward_Path'
 * '<S50>'  : 'TRAS_PID_Azimuth/PID Controller/preSat Signal/Forward_Path'
 */
#endif                                 /* RTW_HEADER_TRAS_PID_Azimuth_h_ */
