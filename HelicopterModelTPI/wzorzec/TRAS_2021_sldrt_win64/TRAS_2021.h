...
#ifndef RTW_HEADER_TRAS_2021_h_
#define RTW_HEADER_TRAS_2021_h_
#include <string.h>
#include <stddef.h>
#ifndef TRAS_2021_COMMON_INCLUDES_
#define TRAS_2021_COMMON_INCLUDES_
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* TRAS_2021_COMMON_INCLUDES_ */

#include "TRAS_2021_types.h"
...
#define TRAS_2021_rtModel              RT_MODEL_TRAS_2021_T

/* Block signals (default storage) */
typedef struct {
  real_T Control;                      /* '<Root>/Saturation' */
...
#define rtB                            TRAS_2021_B
#define BlockIO                        B_TRAS_2021_T
#define rtP                            TRAS_2021_P
#define Parameters                     P_TRAS_2021_T
#define rtDWork                        TRAS_2021_DW
#define D_Work                         DW_TRAS_2021_T

/* Parameters (default storage) */
struct P_TRAS_2021_T_ {
  ...
  real_T Normal_Value;                 /* Expression: 0
                                        ...
                                        */
  real_T MiddleReference_Value;        /* Expression: 0.1
                                        * Referenced by: '<Root>/Middle Reference'
                                        */
  ...
  real_T ConverttoRPM_Gain;            /* Expression: 1000/0.52/2
                                        ...
                                        */
  real_T ZeroAzimuthControl_Value;     /* Expression: 0
                                        * Referenced by: '<Root>/Zero Azimuth Control'
                                        */
...
extern P_TRAS_2021_T TRAS_2021_P;

/* Block signals (default storage) */
extern B_TRAS_2021_T TRAS_2021_B;

/* Block states (default storage) */
extern DW_TRAS_2021_T TRAS_2021_DW;

/* Model entry point functions */
extern void TRAS_2021_initialize(void);
extern void TRAS_2021_output(void);
extern void TRAS_2021_update(void);
extern void TRAS_2021_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern TRAS_2021_rtModel *TRAS_2021(void);
...
extern RT_MODEL_TRAS_2021_T *const TRAS_2021_M;

/*-
 * These blocks were eliminated from the model due to optimizations:
 *
 * Block '<S1>/Azimuth Therm Status' : Unused code path elimination
 * Block '<S1>/PWMGain' : Unused code path elimination
 * Block '<S1>/PWMPrescalerGain' : Unused code path elimination
 * Block '<S1>/Pitch Therm Status' : Unused code path elimination
 * Block '<S1>/ResetEncoderGain' : Unused code path elimination
 * Block '<S1>/ThermFlagGain' : Unused code path elimination
 */
