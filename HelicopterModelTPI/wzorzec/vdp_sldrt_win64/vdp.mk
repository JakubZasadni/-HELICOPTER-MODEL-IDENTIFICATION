...
MODEL                := vdp
MODULES              := rtGetInf.c rtGetNaN.c rt_nonfinite.c vdp_data.c vdp_tgtconn.c
MAKEFILE             := vdp.mk
...
# additional includes
REQ_INCLUDES += ;D:/MATLAB_WORK/LaboratoriumProblemowe/wzorzec;D:/MATLAB_WORK/LaboratoriumProblemowe/wzorzec/vdp_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
