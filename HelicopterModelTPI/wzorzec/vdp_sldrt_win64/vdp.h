...
#define vdp_rtModel                    RT_MODEL_vdp_T
...
#define rtB                            vdp_B
#define BlockIO                        B_vdp_T
#define rtX                            vdp_X
#define ContinuousStates               X_vdp_T
#define rtXdot                         vdp_XDot
#define StateDerivatives               XDot_vdp_T
#define tXdis                          vdp_XDis
#define StateDisabled                  XDis_vdp_T
#define rtY                            vdp_Y
#define ExternalOutputs                ExtY_vdp_T
#define rtP                            vdp_P
#define Parameters                     P_vdp_T
#define rtDWork                        vdp_DW
#define D_Work                         DW_vdp_T
