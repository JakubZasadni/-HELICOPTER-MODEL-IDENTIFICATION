 ...
 * C source code generated on : Thu Dec 12 12:46:06 2024
 *
...
void wzorzec_output(void)
{
  ...
  if (rtmIsMajorTimeStep(wzorzec_M)) {
    ...
    wzorzec_B.AzimuthCtrl = wzorzec_P.AzimuthCtrl_Value;
  }

  /* SignalGenerator: '<Root>/Signal Generator' */
  temp = wzorzec_P.SignalGenerator_Frequency * wzorzec_M->Timing.t[0];
  if (temp - floor(temp) >= 0.5) {
    /* SignalGenerator: '<Root>/Signal Generator' */
    wzorzec_B.SignalGenerator = wzorzec_P.SignalGenerator_Amplitude;
  } else {
    /* SignalGenerator: '<Root>/Signal Generator' */
    wzorzec_B.SignalGenerator = -wzorzec_P.SignalGenerator_Amplitude;
  }
  ...
  if (rtmIsMajorTimeStep(wzorzec_M)) {
    ...
    /* Gain: '<Root>/Gain' */
    wzorzec_B.Gain = wzorzec_P.Gain_Gain * wzorzec_B.Converttorad[1];
  ...
  wzorzec_B.TransferFcn = 0.0;
  wzorzec_B.TransferFcn += wzorzec_P.TransferFcn_C *
    wzorzec_X.TransferFcn_CSTATE;
  if (rtmIsMajorTimeStep(wzorzec_M)) {
    /* ManualSwitch: '<Root>/Reset Encoders' */
    if (wzorzec_P.ResetEncoders_CurrentSetting == 1) {
      /* ManualSwitch: '<Root>/Reset Encoders' incorporates:
       *  Constant: '<Root>/Reset'
       */
      wzorzec_B.ResetEncoders = wzorzec_P.Reset_Value;
    } else {
      /* ManualSwitch: '<Root>/Reset Encoders' incorporates:
       *  Constant: '<Root>/Normal'
       */
      wzorzec_B.ResetEncoders = wzorzec_P.Normal_Value;
    }
  ...
  if (wzorzec_B.AzimuthCtrl > wzorzec_P.Saturation_UpperSat) {
    /* Saturate: '<S1>/Saturation' */
    wzorzec_B.Saturation[0] = wzorzec_P.Saturation_UpperSat;
  } else if (wzorzec_B.AzimuthCtrl < wzorzec_P.Saturation_LowerSat) {
    /* Saturate: '<S1>/Saturation' */
    wzorzec_B.Saturation[0] = wzorzec_P.Saturation_LowerSat;
  } else {
    /* Saturate: '<S1>/Saturation' */
    wzorzec_B.Saturation[0] = wzorzec_B.AzimuthCtrl;
  }

  if (wzorzec_B.SignalGenerator > wzorzec_P.Saturation_UpperSat) {
    /* Saturate: '<S1>/Saturation' */
    wzorzec_B.Saturation[1] = wzorzec_P.Saturation_UpperSat;
  } else if (wzorzec_B.SignalGenerator < wzorzec_P.Saturation_LowerSat) {
    /* Saturate: '<S1>/Saturation' */
    wzorzec_B.Saturation[1] = wzorzec_P.Saturation_LowerSat;
  } else {
    /* Saturate: '<S1>/Saturation' */
    wzorzec_B.Saturation[1] = wzorzec_B.SignalGenerator;
  }
...
void wzorzec_derivatives(void)
{
  ...
  _rtXdot->TransferFcn_CSTATE += wzorzec_P.TransferFcn_A *
    wzorzec_X.TransferFcn_CSTATE;
  _rtXdot->TransferFcn_CSTATE += wzorzec_B.ConverttoRPM[0];
}
...
void wzorzec_initialize(void)
{
  ...
  wzorzec_X.TransferFcn_CSTATE = 0.0;
}
...
RT_MODEL_wzorzec_T *wzorzec(void)
{
  ...
  /* External mode info */
  wzorzec_M->Sizes.checksums[0] = (53808102U);
  wzorzec_M->Sizes.checksums[1] = (1431698696U);
  wzorzec_M->Sizes.checksums[2] = (4149533811U);
  wzorzec_M->Sizes.checksums[3] = (1284522897U);
  ...
  /* register each child */
  {
    ...
    /* Level2 S-Function Block: wzorzec/<S1>/Encoder (TRAS_Encoder) */
    {
      SimStruct *rts = wzorzec_M->childSfunctions[0];
      ...
      ssSetPath(rts, "wzorzec/TRAS/Encoder");
    ...
    /* Level2 S-Function Block: wzorzec/<S1>/Analog Input (TRAS_AnalogInput) */
    {
      SimStruct *rts = wzorzec_M->childSfunctions[1];
      ...
      ssSetPath(rts, "wzorzec/TRAS/Analog Input");
      ssSetRTModel(rts,wzorzec_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
    ...
    /* Level2 S-Function Block: wzorzec/<S1>/PWM (TRAS_PWM) */
    {
      SimStruct *rts = wzorzec_M->childSfunctions[2];
      ...
      /* inputs */
      {
        ...
        /* port 0 */
        {
          ...
          sfcnUPtrs[0] = wzorzec_B.Saturation;
          sfcnUPtrs[1] = &wzorzec_B.Saturation[1];
      ...
      ssSetPath(rts, "wzorzec/TRAS/PWM");
      ssSetRTModel(rts,wzorzec_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
    ...
    /* Level2 S-Function Block: wzorzec/<S1>/ResetEncoder (TRAS_ResetEncoder) */
    {
      SimStruct *rts = wzorzec_M->childSfunctions[3];
      ...
      /* inputs */
      {
        ...
        /* port 0 */
        {
          ...
          sfcnUPtrs[0] = &wzorzec_B.ResetEncoders;
          sfcnUPtrs[1] = &wzorzec_B.ResetEncoders;
          ssSetInputPortSignalPtrs(rts, 0, (InputPtrsType)&sfcnUPtrs[0]);
          _ssSetInputPortNumDimensions(rts, 0, 1);
          ssSetInputPortWidth(rts, 0, 2);
        }
      ...
      ssSetPath(rts, "wzorzec/TRAS/ResetEncoder");
      ssSetRTModel(rts,wzorzec_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
    ...
    /* Level2 S-Function Block: wzorzec/<S1>/Bitstream Version (TRAS_BitstreamVersion) */
    {
      SimStruct *rts = wzorzec_M->childSfunctions[4];
      ...
      ssSetPath(rts, "wzorzec/TRAS/Bitstream Version");
      ssSetRTModel(rts,wzorzec_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
    ...
    /* Level2 S-Function Block: wzorzec/<S1>/Therm Status (TRAS_PWMTherm) */
    {
      SimStruct *rts = wzorzec_M->childSfunctions[5];
      ...
      ssSetPath(rts, "wzorzec/TRAS/Therm Status");
      ssSetRTModel(rts,wzorzec_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
    ...
    /* Level2 S-Function Block: wzorzec/<S1>/PWMPrescaler (TRAS_PWMPrescaler) */
    {
      SimStruct *rts = wzorzec_M->childSfunctions[6];
      ...
      ssSetPath(rts, "wzorzec/TRAS/PWMPrescaler");
      ssSetRTModel(rts,wzorzec_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
    ...
    /* Level2 S-Function Block: wzorzec/<S1>/ThermFlag  (TRAS_ThermFlag) */
    {
      SimStruct *rts = wzorzec_M->childSfunctions[7];
      ...
      ssSetPath(rts, "wzorzec/TRAS/ThermFlag ");
      ssSetRTModel(rts,wzorzec_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
  ...
  /* Initialize Sizes */
  wzorzec_M->Sizes.numContStates = (1);/* Number of continuous states */
  ...
  wzorzec_M->Sizes.numBlocks = (33);   /* Number of blocks */
  wzorzec_M->Sizes.numBlockIO = (18);  /* Number of block outputs */
  wzorzec_M->Sizes.numBlockPrms = (74);/* Sum of parameter "widths" */
  return wzorzec_M;
}
