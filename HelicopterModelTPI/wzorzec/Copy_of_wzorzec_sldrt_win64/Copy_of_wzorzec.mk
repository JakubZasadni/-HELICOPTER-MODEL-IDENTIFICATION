...
MAKECMD         = "C:/apps/MATLAB/R2020a/bin/win64/gmake"
HOST            = ANY
BUILD           = yes
...
MODEL                := Copy_of_wzorzec
MODULES              := rt_matrx.c rt_printf.c Copy_of_wzorzec_data.c Copy_of_wzorzec_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c TRAS_AnalogInput.c TRAS_BitstreamVersion.c TRAS_Encoder.c TRAS_PWM.c TRAS_PWMPrescaler.c TRAS_PWMTherm.c TRAS_ResetEncoder.c TRAS_ThermFlag.c
MAKEFILE             := Copy_of_wzorzec.mk
MATLAB_ROOT          := C:/apps/MATLAB/R2020a
MATLAB_BIN           := C:/apps/MATLAB/R2020a/bin
S_FUNCTIONS_LIB      := 
SOLVER               := 
NUMST                := 1
TID01EQ              := 0
...
SLDRTDIR             := C:/apps/MATLAB/R2020a/toolbox/sldrt
TARGETARCH           := win64
CC_LISTING           := 0
REBUILD_ALL          := 0
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := Copy_of_wzorzec_ref.rsp
...
# additional includes
REQ_INCLUDES += ;D:/MATLAB_WORK/LaboratoriumProblemowe/wzorzec;D:/MATLAB_WORK/LaboratoriumProblemowe/wzorzec/Copy_of_wzorzec_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
