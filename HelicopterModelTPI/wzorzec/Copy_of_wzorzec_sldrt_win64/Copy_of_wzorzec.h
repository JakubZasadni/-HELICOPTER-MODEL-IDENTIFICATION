...
#ifndef RTW_HEADER_Copy_of_wzorzec_h_
#define RTW_HEADER_Copy_of_wzorzec_h_
#include <string.h>
#include <stddef.h>
#ifndef Copy_of_wzorzec_COMMON_INCLUDES_
# define Copy_of_wzorzec_COMMON_INCLUDES_
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* Copy_of_wzorzec_COMMON_INCLUDES_ */

#include "Copy_of_wzorzec_types.h"
...
#define Copy_of_wzorzec_rtModel        RT_MODEL_Copy_of_wzorzec_T

/* Block signals (default storage) */
typedef struct {
  real_T AzimuthCtrl;                  /* '<Root>/AzimuthCtrl' */
  real_T PitchCtrl;                    /* '<Root>/PitchCtrl' */
  real_T Encoder[2];                   /* '<S1>/Encoder' */
  real_T Converttorad[2];              /* '<S1>/Convert to rad' */
  real_T Gain;                         /* '<Root>/Gain' */
  real_T AnalogInput[2];               /* '<S1>/Analog Input' */
  real_T ConverttoRPM[2];              /* '<S1>/Convert to RPM' */
  real_T ResetEncoders;                /* '<Root>/Reset Encoders' */
  real_T Saturation[2];                /* '<S1>/Saturation' */
  real_T PWM[2];                       /* '<S1>/PWM' */
  real_T ResetEncoder[2];              /* '<S1>/ResetEncoder' */
  real_T BitstreamVersion;             /* '<S1>/Bitstream Version' */
  real_T ThermStatus[2];               /* '<S1>/Therm Status' */
  real_T PWMPrescalerSource[2];        /* '<S1>/PWMPrescalerSource' */
  real_T PWMPrescaler[2];              /* '<S1>/PWMPrescaler' */
  real_T ThermFlagSource[2];           /* '<S1>/ThermFlagSource' */
  real_T ThermFlag[2];                 /* '<S1>/ThermFlag ' */
} B_Copy_of_wzorzec_T;
...
typedef struct {
  ...
  struct {
    void *AQHandles;
    void *SlioLTF;
  } TAQSigLogging_InsertedFor_PitchCtrl_at_outport_0_PWORK;/* synthesized block */

  struct {
    void *AQHandles;
    void *SlioLTF;
  } TAQSigLogging_InsertedFor_TRAS_at_outport_0_PWORK;/* synthesized block */

  struct {
    void *AQHandles;
    void *SlioLTF;
  } TAQSigLogging_InsertedFor_TRAS_at_outport_1_PWORK;/* synthesized block */

  struct {
    void *AQHandles;
    void *SlioLTF;
  } TAQSigLogging_InsertedFor_TRAS_at_outport_2_PWORK;/* synthesized block */

  struct {
    void *AQHandles;
    void *SlioLTF;
  } TAQSigLogging_InsertedFor_TRAS_at_outport_3_PWORK;/* synthesized block */
} DW_Copy_of_wzorzec_T;

/* Backward compatible GRT Identifiers */
#define rtB                            Copy_of_wzorzec_B
#define BlockIO                        B_Copy_of_wzorzec_T
#define rtP                            Copy_of_wzorzec_P
#define Parameters                     P_Copy_of_wzorzec_T
#define rtDWork                        Copy_of_wzorzec_DW
#define D_Work                         DW_Copy_of_wzorzec_T

/* Parameters (default storage) */
struct P_Copy_of_wzorzec_T_ {
  ...
  real_T Reset_Value;                  /* Expression: 1
                                        ...
                                        */
  real_T AzimuthCtrl_Value;            /* Expression: 0
                                        * Referenced by: '<Root>/AzimuthCtrl'
                                        */
  real_T PitchCtrl_Value;              /* Expression: 0
...
struct tag_RTM_Copy_of_wzorzec_T {
  const char_T *path;
...
extern P_Copy_of_wzorzec_T Copy_of_wzorzec_P;

/* Block signals (default storage) */
extern B_Copy_of_wzorzec_T Copy_of_wzorzec_B;

/* Block states (default storage) */
extern DW_Copy_of_wzorzec_T Copy_of_wzorzec_DW;

/* Model entry point functions */
extern void Copy_of_wzorzec_initialize(void);
extern void Copy_of_wzorzec_output(void);
extern void Copy_of_wzorzec_update(void);
extern void Copy_of_wzorzec_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Copy_of_wzorzec_rtModel *Copy_of_wzorzec(void);
...
extern RT_MODEL_Copy_of_wzorzec_T *const Copy_of_wzorzec_M;
 ...
 *
 * '<Root>' : 'Copy_of_wzorzec'
 * '<S1>'   : 'Copy_of_wzorzec/TRAS'
 */
#endif                                 /* RTW_HEADER_Copy_of_wzorzec_h_ */
