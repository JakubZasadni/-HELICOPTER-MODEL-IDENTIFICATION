...
MODEL                := wzorzec_nasze
MODULES              := rt_matrx.c rt_printf.c rtGetInf.c rtGetNaN.c rt_nonfinite.c wzorzec_nasze_data.c wzorzec_nasze_tgtconn.c TRAS_AnalogInput.c TRAS_BitstreamVersion.c TRAS_Encoder.c TRAS_PWM.c TRAS_PWMPrescaler.c TRAS_PWMTherm.c TRAS_ResetEncoder.c TRAS_ThermFlag.c
MAKEFILE             := wzorzec_nasze.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := wzorzec_nasze_ref.rsp
...
# additional includes
REQ_INCLUDES += ;D:/MATLAB_WORK/ident_2024_sr_11_30/wzorzec;D:/MATLAB_WORK/ident_2024_sr_11_30/wzorzec/wzorzec_nasze_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
