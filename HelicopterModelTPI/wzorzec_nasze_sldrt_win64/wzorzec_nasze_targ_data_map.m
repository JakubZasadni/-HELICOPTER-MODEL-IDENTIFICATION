    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(59)  = dumData; %prealloc
                    ...
                    ;% wzorzec_nasze_P.StateSpace_B
                    section.data(26).logicalSrcIdx = 25;
                    section.data(26).dtTransOffset = 46;

                    ;% wzorzec_nasze_P.StateSpace_C
                    section.data(27).logicalSrcIdx = 26;
                    section.data(27).dtTransOffset = 55;

                    ;% wzorzec_nasze_P.StateSpace_InitialCondition
                    section.data(28).logicalSrcIdx = 27;
                    section.data(28).dtTransOffset = 64;

                    ;% wzorzec_nasze_P.Integrator_IC
                    ...
                    ;% wzorzec_nasze_P.Saturation_UpperSat_g
                    section.data(32).logicalSrcIdx = 31;
                    section.data(32).dtTransOffset = 70;

                    ;% wzorzec_nasze_P.Saturation_LowerSat_a
    ...
    ;%**************************
        ...
        ;%
            ...
            section.data(22)  = dumData; %prealloc
                    ...
                    ;% wzorzec_nasze_B.StateSpace
                    section.data(8).logicalSrcIdx = 7;
                    section.data(8).dtTransOffset = 11;

                    ;% wzorzec_nasze_B.Sum2
                    section.data(9).logicalSrcIdx = 8;
                    ...
                    ;% wzorzec_nasze_B.TmpSignalConversionAtStateSpaceInport1
                    section.data(13).logicalSrcIdx = 12;
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(7)  = dumData; %prealloc
                    ...
                    ;% wzorzec_nasze_DW.Scope2_PWORK.LoggedData
                    section.data(3).logicalSrcIdx = 2;
                    section.data(3).dtTransOffset = 5;

                    ;% wzorzec_nasze_DW.Scope3_PWORK.LoggedData
                    section.data(4).logicalSrcIdx = 3;
                    section.data(4).dtTransOffset = 6;

                    ;% wzorzec_nasze_DW.Scope4_PWORK.LoggedData
                    section.data(5).logicalSrcIdx = 4;
                    section.data(5).dtTransOffset = 7;

                    ;% wzorzec_nasze_DW.ToWorkspace1_PWORK.LoggedData
                    section.data(6).logicalSrcIdx = 5;
                    section.data(6).dtTransOffset = 8;

                    ;% wzorzec_nasze_DW.ToWorkspace2_PWORK.LoggedData
                    section.data(7).logicalSrcIdx = 6;
    ...
    targMap.checksum0 = 1385554750;
    targMap.checksum1 = 1449960264;
    targMap.checksum2 = 2379191621;
    targMap.checksum3 = 1420451906;
