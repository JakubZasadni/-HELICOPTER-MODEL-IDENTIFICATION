...
void wzorzec_nasze_output(void)
{
  ...
  wzorzec_nasze_B.StateSpace[0] = 0.0;
  wzorzec_nasze_B.StateSpace[1] = 0.0;
  wzorzec_nasze_B.StateSpace[2] = 0.0;
  for (ci = 0; ci < 3; ci++) {
    wzorzec_nasze_B.StateSpace[0] += wzorzec_nasze_P.StateSpace_C[ci * 3] *
      wzorzec_nasze_X.StateSpace_CSTATE[ci];
    wzorzec_nasze_B.StateSpace[1] += wzorzec_nasze_P.StateSpace_C[ci * 3 + 1] *
      wzorzec_nasze_X.StateSpace_CSTATE[ci];
    wzorzec_nasze_B.StateSpace[2] += wzorzec_nasze_P.StateSpace_C[ci * 3 + 2] *
      wzorzec_nasze_X.StateSpace_CSTATE[ci];
  }
   ...
   */
  rtb_Gain1_0 = ((-wzorzec_nasze_P.K[0] * wzorzec_nasze_B.StateSpace[0] +
                  -wzorzec_nasze_P.K[1] * wzorzec_nasze_B.StateSpace[1]) +
                 -wzorzec_nasze_P.K[2] * wzorzec_nasze_B.StateSpace[2]) +
    -wzorzec_nasze_P.K[3] * wzorzec_nasze_X.Integrator_CSTATE;

  /* Sum: '<Root>/Sum2' incorporates:
   *  Constant: '<Root>/Constant'
   *  Gain: '<Root>/Gain1'
   */
  wzorzec_nasze_B.Sum2 = rtb_Gain1_0 + wzorzec_nasze_P.ur;
  if (rtmIsMajorTimeStep(wzorzec_nasze_M)) {
     ...
     */
    wzorzec_nasze_B.Sum = wzorzec_nasze_B.Gain - wzorzec_nasze_P.xr[0];

    /* Sum: '<Root>/Sum1' incorporates:
     *  Constant: '<Root>/Constant2'
     */
    wzorzec_nasze_B.Sum1 = wzorzec_nasze_B.ConverttoRPM[0] - wzorzec_nasze_P.xr
      [2];
  }
   ...
   *  Gain: '<Root>/Gain1'
   */
  wzorzec_nasze_B.TmpSignalConversionAtStateSpaceInport1[0] = rtb_Gain1_0;
  wzorzec_nasze_B.TmpSignalConversionAtStateSpaceInport1[1] =
    wzorzec_nasze_B.Sum;
  wzorzec_nasze_B.TmpSignalConversionAtStateSpaceInport1[2] =
    wzorzec_nasze_B.Sum1;

  /* Saturate: '<S2>/Saturation' */
  if (wzorzec_nasze_B.AzimuthCtrl > wzorzec_nasze_P.Saturation_UpperSat_g) {
    /* Saturate: '<S2>/Saturation' */
    wzorzec_nasze_B.Saturation[0] = wzorzec_nasze_P.Saturation_UpperSat_g;
  } else if (wzorzec_nasze_B.AzimuthCtrl < wzorzec_nasze_P.Saturation_LowerSat_a)
  {
    /* Saturate: '<S2>/Saturation' */
    wzorzec_nasze_B.Saturation[0] = wzorzec_nasze_P.Saturation_LowerSat_a;
  } else {
    /* Saturate: '<S2>/Saturation' */
  ...
  if (wzorzec_nasze_B.Sum2 > wzorzec_nasze_P.Saturation_UpperSat) {
    rtb_Gain1_0 = wzorzec_nasze_P.Saturation_UpperSat;
  } else if (wzorzec_nasze_B.Sum2 < wzorzec_nasze_P.Saturation_LowerSat) {
    rtb_Gain1_0 = wzorzec_nasze_P.Saturation_LowerSat;
  } else {
    rtb_Gain1_0 = wzorzec_nasze_B.Sum2;
  }

  /* End of Saturate: '<Root>/Saturation' */

  /* Saturate: '<S2>/Saturation' */
  if (rtb_Gain1_0 > wzorzec_nasze_P.Saturation_UpperSat_g) {
    /* Saturate: '<S2>/Saturation' */
    wzorzec_nasze_B.Saturation[1] = wzorzec_nasze_P.Saturation_UpperSat_g;
  } else if (rtb_Gain1_0 < wzorzec_nasze_P.Saturation_LowerSat_a) {
    /* Saturate: '<S2>/Saturation' */
    wzorzec_nasze_B.Saturation[1] = wzorzec_nasze_P.Saturation_LowerSat_a;
  } else {
    /* Saturate: '<S2>/Saturation' */
    wzorzec_nasze_B.Saturation[1] = rtb_Gain1_0;
  }
...
void wzorzec_nasze_derivatives(void)
{
  ...
  for (is = 0; is < 3; is++) {
    ...
    _rtXdot->StateSpace_CSTATE[0] += (wzorzec_nasze_P.A[is * 3] -
      wzorzec_nasze_ConstP.StateSpace_rtw_collapsed_sub_expr_0[is * 3]) *
      wzorzec_nasze_X.StateSpace_CSTATE[is];
    StateSpace_CSTATE_tmp = is * 3 + 1;
    _rtXdot->StateSpace_CSTATE[1] += (wzorzec_nasze_P.A[StateSpace_CSTATE_tmp] -
      wzorzec_nasze_ConstP.StateSpace_rtw_collapsed_sub_expr_0[StateSpace_CSTATE_tmp])
      * wzorzec_nasze_X.StateSpace_CSTATE[is];
    StateSpace_CSTATE_tmp = is * 3 + 2;
    _rtXdot->StateSpace_CSTATE[2] += (wzorzec_nasze_P.A[StateSpace_CSTATE_tmp] -
      wzorzec_nasze_ConstP.StateSpace_rtw_collapsed_sub_expr_0[StateSpace_CSTATE_tmp])
      * wzorzec_nasze_X.StateSpace_CSTATE[is];
  }

  for (is = 0; is < 3; is++) {
    _rtXdot->StateSpace_CSTATE[0] += wzorzec_nasze_P.StateSpace_B[is * 3] *
      wzorzec_nasze_B.TmpSignalConversionAtStateSpaceInport1[is];
    _rtXdot->StateSpace_CSTATE[1] += wzorzec_nasze_P.StateSpace_B[is * 3 + 1] *
      wzorzec_nasze_B.TmpSignalConversionAtStateSpaceInport1[is];
    _rtXdot->StateSpace_CSTATE[2] += wzorzec_nasze_P.StateSpace_B[is * 3 + 2] *
      wzorzec_nasze_B.TmpSignalConversionAtStateSpaceInport1[is];
  }
  ...
  _rtXdot->Integrator_CSTATE = wzorzec_nasze_B.StateSpace[0];
}
...
void wzorzec_nasze_initialize(void)
{
  ...
  wzorzec_nasze_X.StateSpace_CSTATE[0] =
    wzorzec_nasze_P.StateSpace_InitialCondition[0];
  wzorzec_nasze_X.StateSpace_CSTATE[1] =
    wzorzec_nasze_P.StateSpace_InitialCondition[1];
  wzorzec_nasze_X.StateSpace_CSTATE[2] =
    wzorzec_nasze_P.StateSpace_InitialCondition[2];

  /* InitializeConditions for Integrator: '<Root>/Integrator' */
  wzorzec_nasze_X.Integrator_CSTATE = wzorzec_nasze_P.Integrator_IC;
}
...
RT_MODEL_wzorzec_nasze_T *wzorzec_nasze(void)
{
  ...
  rtmSetTFinal(wzorzec_nasze_M, 20.0);
  wzorzec_nasze_M->Timing.stepSize0 = 0.01;
  wzorzec_nasze_M->Timing.stepSize1 = 0.01;

  /* External mode info */
  wzorzec_nasze_M->Sizes.checksums[0] = (1385554750U);
  wzorzec_nasze_M->Sizes.checksums[1] = (1449960264U);
  wzorzec_nasze_M->Sizes.checksums[2] = (2379191621U);
  wzorzec_nasze_M->Sizes.checksums[3] = (1420451906U);
  ...
  /* register each child */
  {
    ...
    /* Level2 S-Function Block: wzorzec_nasze/<S2>/Encoder (TRAS_Encoder) */
    {
      SimStruct *rts = wzorzec_nasze_M->childSfunctions[0];
    ...
    /* Level2 S-Function Block: wzorzec_nasze/<S2>/Analog Input (TRAS_AnalogInput) */
    {
      SimStruct *rts = wzorzec_nasze_M->childSfunctions[1];
    ...
    /* Level2 S-Function Block: wzorzec_nasze/<S2>/PWM (TRAS_PWM) */
    {
      SimStruct *rts = wzorzec_nasze_M->childSfunctions[2];
    ...
    /* Level2 S-Function Block: wzorzec_nasze/<S2>/ResetEncoder (TRAS_ResetEncoder) */
    {
      SimStruct *rts = wzorzec_nasze_M->childSfunctions[3];
    ...
    /* Level2 S-Function Block: wzorzec_nasze/<S2>/Bitstream Version (TRAS_BitstreamVersion) */
    {
      SimStruct *rts = wzorzec_nasze_M->childSfunctions[4];
    ...
    /* Level2 S-Function Block: wzorzec_nasze/<S2>/Therm Status (TRAS_PWMTherm) */
    {
      SimStruct *rts = wzorzec_nasze_M->childSfunctions[5];
    ...
    /* Level2 S-Function Block: wzorzec_nasze/<S2>/PWMPrescaler (TRAS_PWMPrescaler) */
    {
      SimStruct *rts = wzorzec_nasze_M->childSfunctions[6];
    ...
    /* Level2 S-Function Block: wzorzec_nasze/<S2>/ThermFlag  (TRAS_ThermFlag) */
    {
      SimStruct *rts = wzorzec_nasze_M->childSfunctions[7];
  ...
  /* Initialize Sizes */
  wzorzec_nasze_M->Sizes.numContStates = (5);/* Number of continuous states */
  ...
  wzorzec_nasze_M->Sizes.numBlocks = (46);/* Number of blocks */
  wzorzec_nasze_M->Sizes.numBlockIO = (22);/* Number of block outputs */
  wzorzec_nasze_M->Sizes.numBlockPrms = (113);/* Sum of parameter "widths" */
