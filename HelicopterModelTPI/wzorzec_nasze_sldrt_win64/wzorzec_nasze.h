...
#ifndef RTW_HEADER_wzorzec_nasze_h_
#define RTW_HEADER_wzorzec_nasze_h_
#include <string.h>
#include <stddef.h>
#ifndef wzorzec_nasze_COMMON_INCLUDES_
#define wzorzec_nasze_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* wzorzec_nasze_COMMON_INCLUDES_ */

#include "wzorzec_nasze_types.h"
...
#define wzorzec_nasze_rtModel          RT_MODEL_wzorzec_nasze_T
...
typedef struct {
  ...
  real_T StateSpace[3];                /* '<S1>/State-Space' */
...
typedef struct {
  ...
  real_T StateSpace_CSTATE[3];         /* '<S1>/State-Space' */
...
typedef struct {
  ...
  real_T StateSpace_CSTATE[3];         /* '<S1>/State-Space' */
  real_T Integrator_CSTATE;            /* '<Root>/Integrator' */
} XDot_wzorzec_nasze_T;

/* State disabled  */
typedef struct {
  boolean_T TransferFcn_CSTATE;        /* '<Root>/Transfer Fcn' */
  boolean_T StateSpace_CSTATE[3];      /* '<S1>/State-Space' */
  boolean_T Integrator_CSTATE;         /* '<Root>/Integrator' */
} XDis_wzorzec_nasze_T;
...
typedef struct {
   ...
   */
  real_T StateSpace_rtw_collapsed_sub_expr_0[9];
} ConstP_wzorzec_nasze_T;

/* Backward compatible GRT Identifiers */
#define rtB                            wzorzec_nasze_B
#define BlockIO                        B_wzorzec_nasze_T
#define rtX                            wzorzec_nasze_X
#define ContinuousStates               X_wzorzec_nasze_T
#define rtXdot                         wzorzec_nasze_XDot
#define StateDerivatives               XDot_wzorzec_nasze_T
#define tXdis                          wzorzec_nasze_XDis
#define StateDisabled                  XDis_wzorzec_nasze_T
#define rtP                            wzorzec_nasze_P
#define Parameters                     P_wzorzec_nasze_T
#define rtDWork                        wzorzec_nasze_DW
#define D_Work                         DW_wzorzec_nasze_T
#define ConstParam                     ConstP_wzorzec_nasze_T
#define rtcP                           wzorzec_nasze_ConstP

/* Parameters (default storage) */
struct P_wzorzec_nasze_T_ {
  ...
  real_T K[4];                         /* Variable: K
                                        ...
                                        */
  real_T ur;                           /* Variable: ur
                                        * Referenced by: '<Root>/Constant'
                                        */
  real_T xr[3];                        /* Variable: xr
                                        * Referenced by:
                                        *   '<Root>/Constant1'
                                        *   '<Root>/Constant2'
                                        */
  ...
  real_T AnalogInput_P4;               /* Expression: T0
                                        * Referenced by: '<S2>/Analog Input'
                                        */
  real_T ConverttoRPM_Gain;            /* Expression: 30/(0.01*3.14)
  ...
  real_T TransferFcn_C;                /* Computed Parameter: TransferFcn_C
                                        * Referenced by: '<Root>/Transfer Fcn'
                                        */
  real_T StateSpace_B[9];              /* Expression: [B L]
                                        * Referenced by: '<S1>/State-Space'
                                        */
  real_T StateSpace_C[9];              /* Expression: eye(3)
                                        * Referenced by: '<S1>/State-Space'
                                        */
  real_T StateSpace_InitialCondition[3];/* Expression: zeros(3,1)
                                         * Referenced by: '<S1>/State-Space'
                                         */
  ...
  real_T Saturation_UpperSat;          /* Expression: 0.6
                                        ...
                                        */
  real_T Saturation_LowerSat;          /* Expression: -0.6
                                        * Referenced by: '<Root>/Saturation'
                                        */
...
struct tag_RTM_wzorzec_nasze_T {
  const char_T *path;
...
extern P_wzorzec_nasze_T wzorzec_nasze_P;

/* Block signals (default storage) */
extern B_wzorzec_nasze_T wzorzec_nasze_B;

/* Continuous states (default storage) */
extern X_wzorzec_nasze_T wzorzec_nasze_X;

/* Block states (default storage) */
extern DW_wzorzec_nasze_T wzorzec_nasze_DW;

/* Constant parameters (default storage) */
extern const ConstP_wzorzec_nasze_T wzorzec_nasze_ConstP;

/* Model entry point functions */
extern void wzorzec_nasze_initialize(void);
extern void wzorzec_nasze_output(void);
extern void wzorzec_nasze_update(void);
extern void wzorzec_nasze_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern wzorzec_nasze_rtModel *wzorzec_nasze(void);
...
extern RT_MODEL_wzorzec_nasze_T *const wzorzec_nasze_M;
 ...
 *
 * '<Root>' : 'wzorzec_nasze'
 * '<S1>'   : 'wzorzec_nasze/Subsystem'
 * '<S2>'   : 'wzorzec_nasze/TRAS'
 */
#endif                                 /* RTW_HEADER_wzorzec_nasze_h_ */
